...
const spotifyLogo = "https://firebasestorage.googleapis.com/v0/b/csc-450-project.appspot.com/o/HAWKFINDER%2Fspotify-logo-7839B39C1B-seeklogo.com.png?alt=media&token=d84fdd6d-08da-4dcd-a9f5-99beba187849"
...
export default function SpotifyLogin(user : User) {
  ...
  if (data != null) {
    return (
      <div>
        <a href="/api/spotify" style={{display:"flex", justifyContent:"space-evenly"}}>
          <Button variant="contained" color="primary">
            <img src={spotifyLogo} style={{height:"60px", width:"60px", paddingRight:"10px"}}></img>
            <h3>Authorize</h3>
          </Button>
        </a>
      </div>
